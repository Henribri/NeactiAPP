      ...
      child: ListView(
        ...
        children: <Widget>[
          ...
          ListTile(
            ...
            title: Text('Me', style: TextStyle(fontSize: 26)),
          ),
          SizedBox(height: 10),
          ListTile(
            onTap: () {
            ...
            title: Text('Invite', style: TextStyle(fontSize: 26)),
          ),
          SizedBox(height: 10),
          ListTile(
            onTap: () {
            ...
            title: Text('Join', style: TextStyle(fontSize: 26)),
          ),
          SizedBox(height: 10),
          ListTile(
            onTap: () {
          ...
          ListTile(
            ...
            title: Text('Donate', style: TextStyle(fontSize: 26)),
          )
        ],
      ),
    );
